...
//** 作者： 刘周南
//** 创建时间：2020-07-31
//** 描述：验证身份证件号    手机号码11位校验      验证教工号或学号或一卡通号
//*********************************************************************************/
...
//验证手机号
function telephoneUtils(telephone) {
    //此正则表达式  为正整数 必须11位数
    var pattern = /^[0-9]{11}$/;
    if (pattern.test(telephone) == true) {
        return true;
    }
    return false;
}
...
//验证教工号或学号或一卡通号
function identityTypeCodeUtils(telephone) {
    //此正则表达式  为正整数 不超过1到15位数
